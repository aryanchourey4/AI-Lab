...
public class Astar {
  ...
  public static void main(String[] args) {
    ...
    n1.adjacencies =
      new Edge[] { new Edge(n2, 75), new Edge(n4, 140), new Edge(n8, 118) };
    ...
    n6.adjacencies =
      new Edge[] { new Edge(n4, 80), new Edge(n7, 97), new Edge(n12, 146) };
    n7.adjacencies =
      new Edge[] { new Edge(n6, 97), new Edge(n13, 101), new Edge(n12, 138) };
    ...
    n12.adjacencies =
      new Edge[] { new Edge(n11, 120), new Edge(n6, 146), new Edge(n7, 138) };
    n13.adjacencies =
      new Edge[] { new Edge(n7, 101), new Edge(n14, 90), new Edge(n5, 211) };
